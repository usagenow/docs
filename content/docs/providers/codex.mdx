...
The app-server also reports your plan — including Team, Business, and Enterprise — which appears as a badge in the popover, even when rate limits aren’t returned for that plan.
